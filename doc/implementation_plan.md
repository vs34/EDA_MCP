...
- Exposes tools:
  ...
  - `eldo(action, command="", work_dir="~/Desktop/eldo")`: Siemens Eldo auto-initialized batch simulation (`action='run_script'`) and interactive REPL (`action='start_interactive'`).
