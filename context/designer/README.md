...
14. **NO_HTML_WAVEFORM_RULE**: Agents MUST NOT generate HTML files, web pages, or local web servers to plot simulation waveforms. ALWAYS use `eldo(action="visualize_waveforms")` to display simulation waveforms in the native PyQtGraph oscilloscope window.
